<?php
$all_products    = $obj1->display_all_product_data( $start, $per_page );
 ?>

<div class="col-md-8 col-sm-12" >
                 <div id="filters" class="button-group">
                     <div class = "my-btn">
                        <a href="?status=sub-menu&&id=1" name = 'all_products' style =  "color:blue;">All Products</a>
                        <a href="?status=sub-menu&&id=2" name = 'new_products'>Newest</a>
